...
<body class="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 relative">
    ...
    <!-- Acceso Directo Staff -->
    <div class="absolute top-4 right-4 flex flex-col sm:flex-row gap-2 z-50">
        <a href="{{ route('asesor.login') }}" class="bg-white/80 backdrop-blur-sm border border-gray-200 text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-xl hover:border-sena-green hover:text-sena-green transition-all shadow-sm flex items-center group">
        ...
        <a href="{{ route('coordinador.login') }}" class="bg-white/80 backdrop-blur-sm border border-gray-200 text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-xl hover:border-black hover:text-black transition-all shadow-sm flex items-center group">
        ...
        <a href="{{ route('turnos.tv') }}" class="bg-sena-green text-white text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-xl hover:bg-black transition-all shadow-md flex items-center group">
    ...
    <div class="mt-16 text-center space-y-4">
        ...
        <div>
            <a href="{{ route('turnos.tv') }}" class="inline-flex items-center text-xs font-bold text-sena-gray hover:text-sena-green transition-colors uppercase tracking-widest border border-gray-200 rounded-full px-4 py-1.5 hover:border-sena-green bg-white/50 backdrop-blur-sm shadow-sm group">
                <svg class="w-3.5 h-3.5 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
